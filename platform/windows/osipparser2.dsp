...
# ADD CPP /nologo /MD /W3 /GX /O2 /D "NDEBUG" /D "SYSTEM_LOGGER_ENABLED" /D "OSIPPARSER2_EXPORTS" /D "ENABLE_TRACE" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "OSIP_MT" /D "USE_TMP_BUFFER" /YX /FD /c
...
# ADD CPP /nologo /MDd /W3 /Gm /GX /ZI /Od /D "SYSTEM_LOGGER_ENABLED" /D "OSIPPARSER2_EXPORTS" /D "_DEBUG" /D "ENABLE_TRACE" /D "ENABLE_DEBUG" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "OSIP_MT" /D "USE_TMP_BUFFER" /FR /YX /FD /GZ  /c
