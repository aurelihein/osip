...
#define MSG_IS_NOTIFY(msg)  (0==strncmp((msg)->strtline->sipmethod,"NOTIFY",6))
#define MSG_IS_SUBSCRIBE(m) (0==strncmp((m)->strtline->sipmethod,"SUBSCRIBE",9))
...
#define to_set_tag(T,V)     generic_param_add((T)->gen_params, sgetcopy("tag"),V)
#define to_get_tag(T,GP)    generic_param_getbyname((T)->gen_params, "tag",GP)
...
#define msg_getdate(P,Q,R)          msg_header_getbyname(( sip_t *)P,"date",Q,(header_t *)R)
#define msg_setencryption(P,R)      msg_setheader((sip_t *)P,(char *)"encryption",R)
#define msg_getencryption(P,Q,R)    msg_header_getbyname(( sip_t *)P,"encryption",Q,(header_t *)R)
#define msg_setorganization(P,R)    msg_setheader((sip_t *)P,(char *)"organization",R)
#define msg_getorganization(P,Q,R)  msg_header_getbyname(( sip_t *)P,"organization",Q,(header_t *)R)
#define msg_setrequire(P,R)         msg_setheader((sip_t *)P,(char *)"require",R)
#define msg_getrequire(P,Q,R)       msg_header_getbyname(( sip_t *)P,"require",Q,(header_t *)R)
#define msg_setsupported(P,R)       msg_setheader((sip_t *)P,(char *)"supported",R)
#define msg_getsupported(P,Q,R)     msg_header_getbyname(( sip_t *)P,"supported",Q,(header_t *)R)
#define msg_settimestamp(P,R)       msg_setheader((sip_t *)P,(char *)"timestamp",R)
#define msg_gettimestamp(P,Q,R)     msg_header_getbyname(( sip_t *)P,"timestamp",Q,(header_t *)R)
#define msg_setuser_agent(P,R)      msg_setheader((sip_t *)P,(char *)"user-agent",R)
#define msg_getuser_agent(P,Q,R)    msg_header_getbyname(( sip_t *)P,"user-agent",Q,(header_t *)R)
#define msg_setcontent_language(P,R) msg_setheader((sip_t *)P,(char *)"content-language",R)
#define msg_getcontent_language(P,Q,R) msg_header_getbyname(( sip_t *)P,"content-language",Q,(header_t *)R)
#define msg_setexpires(P,R)         msg_setheader((sip_t *)P,(char *)"expires",R)
#define msg_getexpires(P,Q,R)       msg_header_getbyname(( sip_t *)P,"expires",Q,(header_t *)R)
#define msg_setin_reply_to(P,R)     msg_setheader((sip_t *)P,(char *)"in-reply-to",R)
#define msg_getin_reply_to(P,Q,R)   msg_header_getbyname(( sip_t *)P,"in-reply-to",Q,(header_t *)R)
#define msg_setmax_forward(P,R)     msg_setheader((sip_t *)P,(char *)"max-forward",R)
#define msg_getmax_forward(P,Q,R)   msg_header_getbyname(( sip_t *)P,"max-forward",Q,(header_t *)R)
#define msg_setpriority(P,R)        msg_setheader((sip_t *)P,(char *)"priority",R)
#define msg_getpriority(P,Q,R)      msg_header_getbyname(( sip_t *)P,"priority",Q,(header_t *)R)
#define msg_setproxy_require(P,R)   msg_setheader((sip_t *)P,(char *)"proxy-require",R)
#define msg_getproxy_require(P,Q,R) msg_header_getbyname(( sip_t *)P,"proxy-require",Q,(header_t *)R)
#define msg_setresponse_key(P,R)    msg_setheader((sip_t *)P,(char *)"response-key",R)
#define msg_getresponse_key(P,Q,R)  msg_header_getbyname(( sip_t *)P,"response-key",Q,(header_t *)R)
#define msg_setsubject(P,R)         msg_setheader((sip_t *)P,(char *)"subject",R)
#define msg_getsubject(P,Q,R)       msg_header_getbyname(( sip_t *)P,"subject",Q,(header_t *)R)
#define msg_setretry_after(P,R)     msg_setheader((sip_t *)P,(char *)"retry-after",R)
#define msg_getretry_after(P,Q,R)   msg_header_getbyname(( sip_t *)P,"retry-after",Q,(header_t *)R)
#define msg_setserver(P,R)          msg_setheader((sip_t *)P,(char *)"server",R)
#define msg_getserver(P,Q,R)        msg_header_getbyname(( sip_t *)P,"server",Q,(header_t *)R)
#define msg_setunsupported(P,R)     msg_setheader((sip_t *)P,(char *)"unsupported",R)
#define msg_getunsupported(P,Q,R)   msg_header_getbyname(( sip_t *)P,"unsupported",Q,(header_t *)R)
#define msg_setwarning(P,R)         msg_setheader((sip_t *)P,(char *)"warning",R)
#define msg_getwarning(P,Q,R)       msg_header_getbyname(( sip_t *)P,"warning",Q,(header_t *)R)
