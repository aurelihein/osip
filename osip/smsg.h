 ...
 * @param dest A pointer on the header found.
 */
int      msg_getcontent_disposition (sip_t *sip, int pos,content_disposition_t **dest);
/**
 ...
 * @param dest A pointer on the copy of the element.
 */
int     accept_encoding_clone(accept_encoding_t *header,accept_encoding_t **dest);
 ...
 * @param dest A pointer on the copy of the element.
 */
int www_authenticate_clone(www_authenticate_t *header,www_authenticate_t **dest);
